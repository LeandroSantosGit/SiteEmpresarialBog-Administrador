            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea name="descricao"
                              ...
                              rows="3"
                              class="form-control"
                              placeholder="Informe a descrição do artigo com tags HTML"><?php
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea name="conteudo"
                              ...
                              rows="3"
                              class="form-control"
                              placeholder="Informe o conteudo do artigo com tags HTML"><?php
                              if (isset($valueForm['conteudo'])) {
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea name="resumo_publico"
                              ...
                              rows="3"
                              class="form-control"
                              placeholder="Informe o resumo público do artigo com tags HTML">
                              <?php if (isset($valueForm['resumo_publico'])) {
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    if (isset($valueForm['imagem']) && !empty($valueForm['imagem'])) {
                        ...
                        $imgActual = URL
                                . 'site/assets/images/article/preview_img.jpg';
                    }
                    ?>
