...
if (!empty($this->dados['infoCatArticle'][0])) {
    extract($this->dados['infoCatArticle'][0]);
?>
<div class="content p-1">
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Visualizar Categoria de Artigo</h2>
            </div>
            <div class="p-2">
                <span class="d-none d-md-block">
                    <?php
                    if ($this->dados['buttonsCatArticle']['listCatArticle']) {
                        echo "<a href='" . URLADM . "list-category-article/list-info-category-article'
                                class='btn btn-outline-info btn-sm mr-2'>
                                 Listar
                             </a>";
                    }
                    if ($this->dados['buttonsCatArticle']['editCatArticle']) {
                        echo "<a href='" . URLADM . "edit-category-article/edit-info-category-article/$id' 
                            class='btn btn-outline-warning btn-sm mr-2'>Editar
                         </a>";
                    }
                    if ($this->dados['buttonsCatArticle']['deleteCatArticle']) {
                        echo "<a href='" . URLADM . "delete-category-article/remove-category-article/$id'
