    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Listar Situação de Página</h2>
            </div>
            <?php
            if ($this->dados['buttonSitPage']['cadSitPage']) {
                echo "<a href='" . URLADM . "register-new-situation-page/register-info-situation-page'>
                    <div class='p-2'>
        ...
        <div class="table-responsive">
            <table class="table table-hover table-striped table-bordered">
                ...
                <tbody>
                    <?php
                    foreach ($this->dados['listSitPage'] as $sitiPg) {
                        extract($sitiPg);
                        ?>
                        <tr>
                            <th><?php echo $id; ?></th>
                            ...
                            <td class="text-center">
                                <span class="d-none d-md-block">
                                    ...
                                    if ($this->dados['buttonSitPage']['viewSitPage']) {
                                        echo "<a href='" . URLADM . "view-info-situation-page/detail-info-situation-page/$id'
