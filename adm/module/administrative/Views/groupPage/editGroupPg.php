    ...
    <div class="list-group-item">
        <div class="d-flex">
            ...
            if ($this->dados['buttonsGrupPg']['viewGrupPg']) {
                ?>
                <div class="p-2">
                    <a href="<?php echo URLADM . 'view-info-group-pg/detail-info-group-pg/' . $valueForm['id']; ?>" 
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input name="nome"
                       type="text"
                       class="form-control"
                       placeholder="Informe nome do grupo de páginas"
                       value="<?php
            ...
            <input name="editGroupPg" type="submit" class="btn btn-success" value="Salvar">
        </form>
    </div>
</div>