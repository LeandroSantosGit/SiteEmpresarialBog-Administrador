    ...
    <div class="list-group-item">
        <div class="d-flex">
            <div class="mr-auto p-2">
                <h2 class="display-4 titulo">Editar Situação Usuário</h2>
            </div>
            <div class="p-2">
                <?php
                $valorFormulario = $valueForm['id'];
                if ($this->dados['buttonSitUser']['viewSitUser']) {
                    echo "<a href='" . URLADM . "view-info-situation-user/detail-info-situation-user/$valorFormulario'
