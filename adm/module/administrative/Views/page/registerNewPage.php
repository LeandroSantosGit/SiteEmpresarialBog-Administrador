    ...
    <div class="list-group-item">
        <div class="d-flex">
            ...
            if ($this->dados['buttonAcesso']['listPage']) { 
                echo "<div class='p-2'>
                        <a href='" . URLADM . "list-page/list-pages'
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input name="nome_pagina"
                           type="text"
                           class="form-control"
                           placeholder="Informe nome que será aparecerá no menu"
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label>Classe do menu<span class="text-danger">*</span></label>
                ...
                <div class="form-group col-md-4">
                    <label>Método do menu<span class="text-danger">*</span></label>
